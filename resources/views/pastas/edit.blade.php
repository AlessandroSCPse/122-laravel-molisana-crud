            ...
            <form action="{{ route('pastas.update', ['pasta' => $pasta->id]) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="type" name="type">
                        <option value="" {{ $pasta->type === '' ? 'selected' : '' }}>Scegli un'opzione</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="origin_country" name="origin_country" value="{{ $pasta->origin_country }}">
                </div>
